...
- **Today's P&L:** ₹0 realized; ~−₹196 combined unrealized on both open index condors — Position A (NIFTY, cost-to-close 40.49 vs credit 37.76 ≈ −₹177) + Position B (SENSEX, cost-to-close 150.85 vs credit 149.91 ≈ −₹19). Both index condors must be force-closed by EOD today per the intraday-only rule.
