...
- **Today's P&L:** ₹0 realized; ~−₹22 unrealized on Position A (NIFTY, cost-to-close ~38.1 vs credit 37.76), Position B (SENSEX) just opened at credit ₹2,998.20 (2026-07-13 intraday — both index condors must be closed by EOD today per intraday-only rule)
