...
- **Today's P&L:** ₹0 realized; ~−₹150 combined unrealized on both open index condors — Position A (NIFTY, cost-to-close 39.69 vs credit 37.76 ≈ −₹125) + Position B (SENSEX, cost-to-close 151.18 vs credit 149.91 ≈ −₹25). Both index condors must be force-closed by EOD today per the intraday-only rule.
